        ...
        <div class="w-full max-w-md bg-white  shadow-lg 2xl p-8 border border-gray-200 ">
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="email" class="w-full xl border-gray-300   text-gray-900  focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-30 transition" type="email" name="email" :value="old('email', $request->email)" required autofocus />
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="password_confirmation" class="w-full xl border-gray-300   text-gray-900  focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-30 transition" type="password" name="password_confirmation" required />
