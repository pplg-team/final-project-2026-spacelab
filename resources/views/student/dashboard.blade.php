<x-app-layout>
    ...
    @if ($attendanceRecord)
        <div class="fixed right-4 bottom-4 w-full max-w-md z-50">
            <div class="bg-white dark:bg-slate-800 shadow-xl border border-slate-200 dark:border-slate-700 p-5">
                <div class="flex items-start gap-4">
                    <div class="w-16 h-16 bg-red-100 dark:bg-red-500/20 flex items-center justify-center">
        ...
        <main class="mx-auto max-w-7xl px-4 md:px-10 space-y-10">
            ...
            <header class="flex flex-col md:flex-row justify-between gap-4">
                ...
                <div>
                    ...
                    <img src="{{ Auth::user()->student->avatar_url }}"
                        ...
                        class="w-16 h-16 object-cover border-2 border-slate-300 dark:border-slate-600">
                </div>
            </header>

            <!-- Stats -->
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <article class=p-5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-10 h-10 bg-sky-50 dark:bg-sky-500/10 flex items-center justify-center">
                ...
                <article class=p-5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-10 h-10 bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                <div
                                    class="w-10 h-10 bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center">
                        ...
                        <div class="pt-4 sm:pt-0 sm:pl-4 sm:border-l border-slate-200 dark:border-slate-700">
                            <div class="flex items-center justify-between mb-3">
                                <div
                                    class="w-10 h-10 bg-yellow-50 dark:bg-yellow-500/10 flex items-center justify-center">
            ...
            <section class="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div class="xl:col-span-8 space-y-6">
                    ...
                    <div class=border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                        <div class="p-6">
                            @if ($schedulesToday->isEmpty())
                                <div class="text-center py-12">
                                    <div
                                        class="inline-flex items-center justify-center w-20 h-20 bg-slate-100 dark:bg-slate-700 mb-5 shadow-sm">
                                        ...
                                        <div class="relative group">
                                            ...
                                            @php
                                                ...
                                                if (!$isTeaching) {
                                                    ...
                                                    $cardClasses =
                                                        'bg-sky-50 dark:bg-sky-500/10 border-sky-200 dark:border-sky-500/40 shadow-sm';
                                                } elseif ($isPast) {
                                                    $cardClasses =
                                            ...
                                            <div class="relative overflow-hidden border {{ $cardClasses }}">
                                                ...
                                                @if ($isPast)
                                                    <div
                                                        class="absolute top-3 right-3 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-100 px-3 py-1 shadow-sm">
                                                ...
                                                <div class="p-5">
                                                    <div class="flex flex-col lg:flex-row gap-5">
                                                        <div class="flex-shrink-0">
                                                            <div
                                                                class="inline-flex flex-col items-center justify-center p-4 min-w-[100px] shadow-sm {{ $isOngoing ? 'bg-sky-500 text-white ring-2 ring-sky-200 dark:ring-sky-500/60' : 'bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white' }}">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <div class="mb-4">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @if ($subjectCode)
                                                                        <span
                                                                            class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-200">
                                                                            {{ $subjectCode }}
                                                                        </span>
                                                                    @endif
                                                                @endif
                                                            ...
                                                            <div class="grid md:grid-cols-3 gap-4">
                                                                @if ($isTeaching)
                                                                    <div
                                                                        class="flex items-center gap-3 bg-white dark:bg-slate-900 p-3 shadow-sm border border-slate-100 dark:border-slate-800">
                                                                        <img src="{{ $teacherAvatarUrl }}"
                                                                            alt="Guru"
                                                                            class="w-11 h-11 object-cover border-2 shadow {{ $isOngoing ? 'border-sky-300 ring-2 ring-sky-100 dark:ring-sky-500/60' : 'border-slate-200 dark:border-slate-700' }}">
                                                                        <div class="flex-1 min-w-0">
                                                                            <p
                                                                    ...
                                                                    <div
                                                                        class="flex items-center gap-3 bg-white dark:bg-slate-900 p-3 shadow-sm border border-slate-100 dark:border-slate-800">
                                                                        <div
                                                                            class="flex-shrink-0 w-11 h-11 bg-slate-200 dark:bg-slate-800 flex items-center justify-center shadow">
                                                                ...
                                                                @else
                                                                    <div
                                                                        class="md:col-span-3 bg-white dark:bg-slate-900 p-3 shadow-sm border border-slate-100 dark:border-slate-800">
                                                                        <p
                ...
                <aside class="xl:col-span-4 space-y-6">
                    <div class=p-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="text-lg font-bold text-slate-900 dark:text-white">Absensi &amp; Konsistensi</h2>
                            <span
                                class="text-xs font-bold text-sky-500 dark:text-sky-300 uppercase">{{ \Carbon\Carbon::now()->locale('id')->translatedFormat('F Y') }}</span>
                        </div>
                        ...
                        <div class="grid grid-cols-7 gap-2 mb-6">
                            ...
                            <!-- Current Month Days -->
                            <div
                                class="aspect-square flex items-center justify-center text-xs font-bold bg-green-500/15 text-green-600 dark:text-green-300 border border-green-500/30">
                                1</div>
                            <div
                                class="aspect-square flex items-center justify-center text-xs font-bold bg-green-500/15 text-green-600 dark:text-green-300 border border-green-500/30">
                                2</div>
                            ...
                            <div
                                ...
                                4</div>
                            <div
                                class="aspect-square flex items-center justify-center text-xs font-bold bg-red-500/10 text-red-600 dark:text-red-300 border border-red-500/30">
                                5</div>
                            <div
                                class="aspect-square flex items-center justify-center text-xs font-bold bg-green-500/15 text-green-600 dark:text-green-300 border border-green-500/30">
                                6</div>
                            ...
                            <div
                                ...
                                10</div>
                            <div
                                class="aspect-square flex items-center justify-center text-xs font-bold bg-sky-500 text-white ring-2 ring-sky-400/60 ring-offset-2 ring-offset-white dark:ring-offset-slate-800">
                                11</div>
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/40 border border-slate-200 dark:border-slate-700">
                                <div class="flex items-center gap-3">
