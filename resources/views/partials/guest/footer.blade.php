<footer class="mt-12 border-t border-slate-200   py-12">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
      ...
      <nav class="flex justify-center md:justify-start items-center">
        <ul class="flex flex-wrap justify-center md:justify-start gap-3 text-sm text-slate-600 ">
      ...
      <div class="flex flex-col items-center md:items-end text-center md:text-right gap-4">
        <div class="text-sm text-slate-500 ">&copy; {{ date('Y') }} SpaceLab. All rights reserved.</div>

        <div class="flex items-center gap-2 text-sm text-slate-500 ">
          <span class="sr-only">Crafted with</span>
          <x-heroicon-s-heart class="w-4 h-4 text-red-800 " fill="currentColor" />
