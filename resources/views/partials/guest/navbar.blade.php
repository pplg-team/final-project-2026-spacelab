<nav x-data="{ mobileOpen: false }" @keydown.window.escape="mobileOpen = false"
    class="fixed inset-x-0 top-0 z-50 bg-white/95 backdrop-blur-sm shadow-md">

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <!-- Logo -->
            <div class="flex items-center space-x-3 bg-white/80 px-3 py-1 md">
            ...
            <div class="flex items-center space-x-3 text-sm">
                ...
                @if (!request()->routeIs('login'))
                    ...
                    <button id="mobile-menu-btn"
                        ...
                        class="md:hidden p-2 md hover:bg-slate-100 transition"
        ...
        @if (!request()->routeIs('login'))
            <div id="mobile-menu" x-cloak x-show="mobileOpen" :aria-hidden="!mobileOpen" x-transition:enter="transition ease-out duration-150"
                ...
                class="md:hidden bg-white/95 border-t border-gray-100 z-40">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
