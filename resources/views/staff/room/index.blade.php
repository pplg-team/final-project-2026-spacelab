        ...
        <div class="space-y-6">
            ...
            <div class="bg-white  shadow-sm sm:lg">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 ">Manajemen Gedung & Ruangan
                            </h3>
            ...
            <div class="space-y-4">
                @forelse($buildings as $building)
                    <div class="bg-white  shadow-sm sm:lg overflow-hidden building-card"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="h-12 w-12 lg bg-gray-100  flex items-center justify-center">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="text-sm font-medium text-indigo-600 ">{{ $building->code }}</span>
                ...
                @empty
                    <div class="bg-white  shadow-sm sm:lg">
                        <div class="p-12 text-center">
                            ...
                            <h3 class="text-sm font-medium text-gray-900 ">Belum ada data gedung</h3>
                            <p class="mt-1 text-sm text-gray-500 ">Tambahkan gedung baru untuk
                                memulai</p>
                            <div class="mt-6">
                                <button x-data=""
                                    x-on:click.prevent="$dispatch('open-modal', 'add-building-modal')"
                                    class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium md text-white bg-gray-800 hover:bg-gray-700    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('staff.rooms.store') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700  mb-1">Kapasitas</label>
                ...
                <div class="flex items-center">
                    ...
                    <label for="addIsActive" class="ml-2 text-sm text-gray-600 ">Ruangan
                        aktif</label>
                </div>
            ...
            <form id="editRoomForm" method="POST" class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="editIsActive" value="1"
                        class=" border-gray-300  text-indigo-600 shadow-sm focus:ring-indigo-500 ">
                    <label for="editIsActive" class="ml-2 text-sm text-gray-600 ">Ruangan
                        aktif</label>
                </div>
