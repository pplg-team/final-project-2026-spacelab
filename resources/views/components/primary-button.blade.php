...
<button {{ $attributes->merge(['type' => 'submit', 'class' => $widthClass . ' flex items-center justify-center gap-2 px-4 py-2.5 bg-[#2563eb]  text-white hover:bg-[#1d4ed8]  focus:outline-none focus:ring-2 focus:ring-slate-900  focus:ring-offset-2 transition font-medium']) }}>
    {{ $slot }}
</button>
