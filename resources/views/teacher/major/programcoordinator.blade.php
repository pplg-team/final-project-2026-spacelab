        ...
        <article role="article" aria-label="Hari Ini"
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h3 class="text-sm md:text-2xl font-extrabold text-gray-900  capitalize">Senin</h3>
                    <p class="text-[10px] md:text-xs text-gray-400  mt-2">07.45</p>
                </div>
                <div class="bg-gray-50  p-2 md:p-3 lg flex items-center justify-center border border-gray-100 ">
                    <span class="sr-only">Icon</span>
                                    ...
                                    @foreach($teachers as $t)
                                        <li class="py-3 flex items-center justify-between">
                                            <div class="flex items-center gap-3">
                                                <img src="{{ $t->teacher?->avatar ?? $t->avatar ?? asset('assets/images/avatar/default-profile.png') }}" alt="{{ $t->user?->name ?? 'Guru' }}" class="w-10 h-10 object-cover border border-gray-200  shadow-sm" />
                                                <div class="min-w-0">
