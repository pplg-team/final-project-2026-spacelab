                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="bg-gray-50  lg p-3">
                                            <div class="text-xs font-medium text-gray-500  mb-1">Kode Pegawai</div>
                                            <div class="text-sm font-semibold text-gray-900 ">{{ $teacher->code ?? '-' }}</div>
                                        </div>

                                        <!-- Phone -->
                                        <div class="bg-gray-50  lg p-3">
                                            <div class="text-xs font-medium text-gray-500  mb-1">Telepon</div>
                                            <div class="text-sm font-semibold text-gray-900 ">{{ $teacher->phone ?? '-' }}</div>
                                        </div>

                                        <!-- Email -->
                                        <div class="bg-gray-50  lg p-3">
                                            <div class="text-xs font-medium text-gray-500  mb-1">Email</div>
                                            <div class="text-sm font-semibold text-gray-900  break-all">{{ $user->email }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="border border-gray-200  lg p-4 hover:border-gray-300  transition duration-150">
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    <div class="text-xs font-medium text-gray-500  mb-1">Mata Pelajaran</div>
                                        ...
                                        <div class="border border-gray-200  lg p-4 hover:border-gray-300  transition duration-150">
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    <div class="text-xs font-medium text-gray-500  mb-1">Wali Kelas</div>
                                                    <div class="text-base font-semibold text-gray-900 ">
                                        ...
                                        <div class="border border-gray-200  lg p-4 hover:border-gray-300  transition duration-150 col-span-2">
                                            <div class="flex items-start">
                                                <div class="flex-shrink-0">
                                                    <div class="w-10 h-10 bg-gray-100  lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-gray-500 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div class="ml-3 flex-1">
                                                    <div class="text-xs font-medium text-gray-500  mb-1">Tugas & Jabatan</div>
                                                    <div class="text-base font-semibold text-gray-900 ">
