            ...
            <div class="bg-white  shadow-sm sm:lg">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 ">Manajemen Staff</h3>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                class="p-1.5 text-gray-600 hover:bg-gray-100  md transition-colors"
                                ...
                                <tr id="emptyState">
                                    <td colspan="5" class="px-4 py-12 text-center">
                                        ...
                                        <h3 class="text-sm font-medium text-gray-900 ">Belum ada data
                                            staff</h3>
                                        <p class="mt-1 text-sm text-gray-500 ">Tambahkan staff baru
                                            untuk memulai</p>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div class="ml-3 flex-1">
                    ...
                    <p class="mt-2 text-sm text-gray-600 ">
                        ...
                        Password akan direset ke default: <code
                            class="bg-gray-100  px-2 py-0.5 ">staff123</code>
                    </p>
                </div>
            </div>
