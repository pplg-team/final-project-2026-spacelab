            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-4 bg-gray-50/70 dark:bg-gray-900/40">
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-3" id="health-summary">
                        ...
                        <div class="xl border border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-900/20 p-4">
                        ...
                        <div class="xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/20 p-4">
