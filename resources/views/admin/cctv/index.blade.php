<x-app-layout title="Pantau Ruangan" description="Pantau ruangan aktif dan status kamera CCTV">
            ...
            <div class="bg-white dark:bg-gray-900/50 shadow-sm sm:lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="flex  justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('admin.cctv.playback.index') }}"
                            class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-900/40">
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-3">
                        ...
                        <div class="xl border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20 p-4">
                            ...
                            @forelse ($rooms as $room)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 align-top">
                                    ...
                                    <td class="px-3 py-4">
                                        <div class="space-y-1">
                                            <span
                                                class="{{ $cameraTypeValue === 'ip_camera' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300' : ($cameraTypeValue === 'webcam' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300') }} inline-flex items-center px-2 py-1 text-xs font-semibold">
                                                {{ $cameraLabel }}
                                            </span>
                                    ...
                                    <td class="px-3 py-4">
                                        @if ($hasIpPreview)
                                            <div class="relative w-[170px] h-[96px] lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-900">
                                        ...
                                        @elseif ($hasWebcamPreview)
                                            <div class="relative w-[170px] h-[96px] lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-black">
                                                <video
                                        ...
                                        @else
                                            <div class="w-[170px] h-[96px] lg border border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center text-xs text-gray-500 dark:text-gray-400 px-3 text-center">
                                    ...
                                    <td class="px-3 py-4">
                                        @if ($entry)
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-semibold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300">
                                                Sedang Dipakai
                                            </span>
                                        @else
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-semibold bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300">
                                                Tidak Dipakai
                                            </span>
                                        @endif
                                    </td>
                                    <td class="px-3 py-4 text-right">
                                        <div class="inline-flex items-center justify-end gap-2">
                                            <button
                                                type="button"
                                                class="open-monitor-btn inline-flex items-center px-3 py-1.5 md border border-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/20 text-xs font-medium text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/30"
                                                data-room="{{ $room->name }}"
                                            ...
                                            <a href="{{ route('admin.cctv.settings.index', ['search' => $room->name]) }}"
                                                class="inline-flex items-center px-3 py-1.5 md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                                Konfigurasi
                                            </a>
                                        </div>
                                    </td>
                    ...
                    <div class="px-4 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-900/40">
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                            ...
                            <div class="flex items-center flex-wrap gap-2">
                                <a href="{{ $rooms->url(1) }}"
                                    class="{{ $rooms->onFirstPage() ? 'pointer-events-none opacity-50' : '' }} inline-flex items-center px-3 py-1.5 md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    Pertama
                                </a>
                                ...
                                @for ($page = $startPage; $page <= $endPage; $page++)
                                    <a href="{{ $rooms->url($page) }}"
                                        class="{{ $page === $currentPage ? 'bg-blue-600 border-blue-600 text-white' : 'bg-white dark:bg-gray-900/50 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700' }} inline-flex items-center justify-center w-9 h-9 md border text-xs font-semibold">
                                        {{ $page }}
                                    </a>
                                @endfor

                                <a href="{{ $rooms->nextPageUrl() ?? '#' }}"
                                    class="{{ $rooms->hasMorePages() ? '' : 'pointer-events-none opacity-50' }} inline-flex items-center px-3 py-1.5 md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    Berikutnya
                                </a>

                                <a href="{{ $rooms->url($lastPage) }}"
                                    class="{{ $currentPage === $lastPage ? 'pointer-events-none opacity-50' : '' }} inline-flex items-center px-3 py-1.5 md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    Terakhir
                                </a>
                            </div>
                        </div>
    ...
    <div id="monitor-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-gray-900/60 p-4">
        <div class="w-full max-w-5xl xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/50 shadow-2xl overflow-hidden">
            <div class="flex items-start justify-between gap-3 p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <button
                    ...
                    type="button"
                    class="inline-flex items-center justify-center w-9 h-9 md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                    <span class="sr-only">Tutup</span>
                    <x-heroicon-o-x-mark class="w-5 h-5" />
                </button>
            </div>
            <div class="p-4">
                <div id="monitor-empty-state" class="hidden lg border border-dashed border-gray-300 dark:border-gray-600 p-6 text-center text-sm text-gray-500 dark:text-gray-400">
                    Kamera tidak aktif atau belum dikonfigurasi untuk ruangan ini.
                </div>

                <div id="monitor-ip-wrapper" class="hidden">
                    <div class="relative lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-black aspect-video">
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-3">
