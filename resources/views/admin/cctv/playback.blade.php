                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50/70 dark:bg-gray-900/40">
                    <form method="GET" action="{{ route('admin.cctv.playback.index') }}" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3">
                        ...
                        <div class="flex items-end gap-2">
                            <button type="submit"
                                class="inline-flex items-center justify-center px-4 py-2 bg-gray-800 dark:bg-gray-700 border border-transparent md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 active:bg-gray-900 dark:active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                    ...
                    <div class="p-6">
                        ...
                        <div id="timeline-container" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                                <div class="flex items-center gap-2 md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2">
                                    <div class="w-3 h-3 bg-green-500 "></div>
                                    <span class="text-gray-600 dark:text-gray-400">Tersedia</span>
                                </div>
                                <div class="flex items-center gap-2 md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2">
                                    <div class="w-3 h-3 bg-gray-300 dark:bg-gray-600 "></div>
                        ...
                        <div id="segment-info" class="mt-6 p-4 bg-gray-50 dark:bg-gray-900/30 lg border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between gap-2 mb-3">
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Informasi Segmen Terpilih</h4>
                                <span id="segment-state-badge" class="inline-flex items-center px-2 py-1 text-[11px] font-semibold bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300">
                                    Belum dipilih
                                </span>
                            </div>
