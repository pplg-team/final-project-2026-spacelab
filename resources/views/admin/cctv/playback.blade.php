        ...
        <div class="space-y-6">
            ...
            <div class="bg-white  shadow-sm sm:lg border border-gray-200  overflow-hidden">
                <div class="p-6 border-b border-gray-200 ">
                    <h3 class="text-lg font-medium text-gray-900 ">Pilih Ruangan & Tanggal</h3>
                    <p class="mt-1 text-sm text-gray-600 ">Pilih ruangan dan tanggal untuk melihat rekaman CCTV</p>
                </div>
                ...
                <div class="p-6 border-b border-gray-200  bg-gray-50/70 ">
                    <form method="GET" action="{{ route('admin.cctv.playback.index') }}" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3">
                        ...
                        <div>
                            <label for="status" class="block text-sm font-medium text-gray-700  mb-2">Status Kamera</label>
                        ...
                        <div class="flex items-end gap-2">
                            <button type="submit"
                                class="inline-flex items-center justify-center px-4 py-2 bg-gray-800  border border-transparent md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700  focus:bg-gray-700  active:bg-gray-900  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2  transition ease-in-out duration-150">
                ...
                <div class="bg-white  shadow-sm sm:lg border border-gray-200  overflow-hidden">
                    <div class="p-6 border-b border-gray-200 ">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 ">{{ $selectedRoom->name }}</h3>
                                <p class="mt-1 text-sm text-gray-600 ">
                                    {{ optional($selectedRoom->building)->name }} - {{ \Carbon\Carbon::parse($date)->isoFormat('dddd, D MMMM Y') }}
                                </p>
                            </div>
                            <div class="text-right">
                                <p class="text-xs text-gray-500 ">Tipe Kamera</p>
                                @php
                    ...
                    <div class="p-6">
                        ...
                        <div id="timeline-container" class="space-y-4">
                            <div class="flex items-center justify-between gap-3">
                                <h4 class="text-sm font-semibold text-gray-900 ">Timeline Rekaman (24 Jam)</h4>
                                <div class="flex items-center gap-3">
                                    <p id="timeline-summary" class="text-xs text-gray-500 ">Memuat data timeline...</p>
                                    <div id="timeline-loading" class="hidden text-xs text-gray-500 ">
                                        Memuat timeline...
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg border border-gray-200  bg-gray-50  p-3">
                                <div class="overflow-x-auto">
                                    ...
                                    <div id="timeline-hour-labels" class="grid gap-1 min-w-[760px] mt-2 text-[10px] text-gray-500 " style="grid-template-columns: repeat(24, minmax(0, 1fr));">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                                <div class="flex items-center gap-2 md border border-gray-200  bg-white  px-3 py-2">
                        ...
                        <div id="segment-info" class="mt-6 p-4 bg-gray-50  lg border border-gray-200 ">
                            <div class="flex items-center justify-between gap-2 mb-3">
                                <h4 class="text-sm font-semibold text-gray-900 ">Informasi Segmen Terpilih</h4>
                                <span id="segment-state-badge" class="inline-flex items-center px-2 py-1 text-[11px] font-semibold bg-gray-100 text-gray-700  ">
                                    Belum dipilih
                                </span>
                            </div>
                            <p id="segment-empty-hint" class="mb-4 text-xs text-gray-500 ">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                <div>
                                    ...
                                    <p id="segment-start" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Waktu Selesai</p>
                                    <p id="segment-end" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Durasi</p>
                                    <p id="segment-duration" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Ukuran File</p>
                                    <p id="segment-size" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Mode Rekam</p>
                                    <p id="segment-mode" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Codec</p>
                                    <p id="segment-codec" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Resolusi</p>
                                    <p id="segment-resolution" class="font-medium text-gray-900 ">-</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 ">Integrity</p>
                                    <p id="segment-integrity" class="font-medium text-gray-900 ">-</p>
                                </div>
                            </div>
                        </div>
                    </div>
