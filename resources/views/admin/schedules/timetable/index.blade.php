<x-app-layout :title="$title" :description="$description">
    ...
    <div class="py-2 flex items-center justify-between ml-4">
        {{-- Kembali --}}
        <div>
            <a href="{{ route('admin.schedules.index') }}" class="inline-flex items-center px-4 py-2 bg-white  border border-gray-300  md font-semibold text-xs text-gray-700  uppercase tracking-widest shadow-sm hover:bg-gray-50  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2  transition ease-in-out duration-150">
    ...
    <x-modal name="add-entry-modal" focusable>
        <div class="p-6">
            ...
            <form id="addEntryForm" method="POST" action="{{ route('admin.schedules.entries.store') }}"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700  mb-1">Mata
                        Pelajaran *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700  mb-1">Guru
                        (Tersedia) *</label>
                    <select name="teacher_subject_id" id="addTeacherSubject" required disabled
                        class="w-full md border-gray-300    shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm disabled:opacity-60">
