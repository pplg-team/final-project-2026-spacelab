<x-app-layout :title="$title" :description="$description">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-3 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-white  overflow-hidden shadow-sm sm:lg">
                    <div class="px-6 py-4 border-b border-gray-200 ">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500 ">{{ __('Total Jadwal') }}
                                </p>
                                <p class="text-3xl font-bold text-gray-800  mt-2">42</p>
                                <p class="text-xs text-gray-500  mt-1">
                                    {{ __('Tersebar di semua kelas') }}</p>
                            </div>
                            <div class="p-3 bg-blue-100  full">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 ">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-gray-500  mt-1">{{ __('Jam pelajaran') }}</p>
                            </div>
                            <div class="p-3 bg-green-100  full">
                ...
                <div class="bg-white  overflow-hidden shadow-sm sm:lg">
                    <div class="px-6 py-4 border-b border-gray-200 ">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500 ">{{ __('Total Kelas') }}
                                </p>
                                <p class="text-3xl font-bold text-gray-800  mt-2">12</p>
                                <p class="text-xs text-gray-500  mt-1">{{ __('dengan jadwal') }}</p>
                            </div>
                            <div class="p-3 bg-purple-100  full">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 ">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-gray-500  mt-1">{{ __('dalam penggunaan') }}
                                </p>
                            </div>
                            <div class="p-3 bg-orange-100  full">
            ...
            <div class="mb-8">
                <h3 class="text-lg font-semibold text-gray-800  mb-16">{{ __('Kelola Jadwal') }}</h3>
                <div class="flex justify-center gap-6 flex-wrap">
                    <!-- Manage Class Schedules -->
                    <a href="{{ route('admin.schedules.timetable.index') }}"
                        class="group bg-white  hover:shadow-lg hover:shadow-blue-200  transition-shadow overflow-hidden shadow-sm sm:lg border-l-4 border-blue-600">
                        <div class="px-6 py-5">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <span
                                        class="inline-flex items-center text-blue-600  text-sm font-medium group-hover:translate-x-1 transition-transform">
                                        {{ __('Lihat Jadwal') }}
                                ...
                                <div class="p-3 bg-blue-100  lg ml-4">
                    ...
                    <a href="#"
                        class="group bg-white  hover:shadow-lg hover:shadow-green-200  transition-shadow overflow-hidden shadow-sm sm:lg border-l-4 border-green-600">
                        <div class="px-6 py-5">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-base font-semibold text-gray-800  mb-2">
                                    ...
                                    <span
                                        class="inline-flex items-center text-green-600  text-sm font-medium group-hover:translate-x-1 transition-transform">
                                        {{ __('Lihat Jadwal') }}
                                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="p-3 bg-green-100  lg ml-4">
                    ...
                    {{-- <a href="{{ route('schedules.conflicts') }}" 
                       class="group bg-white  hover:shadow-lg hover:shadow-red-200  transition-shadow overflow-hidden shadow-sm sm:lg border-l-4 border-red-600">
                        <div class="px-6 py-5">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-base font-semibold text-gray-800  mb-2">
                                    ...
                                    <span class="inline-flex items-center text-red-600  text-sm font-medium group-hover:translate-x-1 transition-transform">
                                        {{ __('Kelola') }}
                                ...
                                <div class="p-3 bg-red-100  lg ml-4">
