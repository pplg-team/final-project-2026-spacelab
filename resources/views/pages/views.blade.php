        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('views.rooms') }}"
                    class="group relative bg-white  border border-slate-200  p-8 hover:border-slate-400  transition-all duration-300 hover:-translate-y-1">
                    <div
                        class="w-14 h-14 bg-blue-500  flex items-center justify-center mb-6 transition-colors">
                        <x-heroicon-o-building-office-2 class="w-7 h-7 text-white" />
                    </div>
                    <h3 class="text-lg font-semibold text-slate-900  mb-2">Lihat Ruangan</h3>
                    <p class="text-sm text-slate-600  leading-relaxed mb-4">
                        Jelajahi semua ruangan & gedung, lihat jadwal penggunaan dan status ketersediaan saat ini.
                    </p>
                    <span
                        class="inline-flex items-center text-sm font-medium text-slate-500  group-hover:text-slate-700  transition-colors">
                        Jelajahi
                ...
                <a href="{{ route('views.search-student') }}"
                    class="group relative bg-white  border border-slate-200  p-8 hover:border-slate-400  transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div
                        class="w-14 h-14 bg-slate-100  flex items-center justify-center mb-6 group-hover:bg-slate-200  transition-colors">
                        <x-heroicon-o-user-group class="w-7 h-7 text-slate-700 " />
                    </div>
                ...
                <a href="{{ route('views.search-teacher') }}"
                    class="group relative bg-white  border border-slate-200  p-8 hover:border-slate-400  transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <div
                        class="w-14 h-14 bg-purple-500  flex items-center justify-center mb-6 transition-colors">
                        <x-heroicon-o-academic-cap class="w-7 h-7 text-white" />
                    </div>
                    <h3 class="text-lg font-semibold text-slate-900  mb-2">Cari Guru</h3>
                    <p class="text-sm text-slate-600  leading-relaxed mb-4">
