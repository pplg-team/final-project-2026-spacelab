<x-guest-layout title="Detail Ruangan" description="Lihat detail ruangan, jadwal, dan penggunaan">
    ...
    <section 
        ...
        <div class="max-w-6xl mx-auto w-full flex-1 flex flex-col min-h-0">
            ...
            {{-- Room Info Card --}}
            <div
                class="bg-white dark:bg-slate-950 xl border border-slate-200 dark:border-slate-800 p-4 mb-4 flex-shrink-0">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-10 h-10 bg-slate-100 dark:bg-slate-800 xl flex items-center justify-center">
                    ...
                    <div class="flex-shrink-0">
                        @if ($ongoingEntry)
                            <div
                                class="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 xl px-4 py-2 text-center min-w-[140px]">
                                <span
                        ...
                        @else
                            <div
                                class="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 xl px-4 py-2 text-center min-w-[140px]">
                                <span
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-0">
                {{-- Today's Schedule --}}
                <div 
                    class="lg:col-span-2 bg-white dark:bg-slate-950 xl border border-slate-200 dark:border-slate-800 flex flex-col min-h-0">
                    <div class="px-6 py-3 border-b border-slate-200 dark:border-slate-800 flex-shrink-0 flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-medium bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 px-2 py-0.5 full">
                            ...
                            @foreach ($todayEntries as $entry)
                                ...
                                <div
                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        @elseif($isPast)
                                            <span class="w-2.5 h-2.5 bg-slate-300 dark:bg-slate-700 block"></span>
                                        @else
                                            <span class="w-2.5 h-2.5 border-2 border-slate-200 dark:border-slate-800 block"></span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span class="text-[10px] font-medium text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 ">
                ...
                <div class="flex flex-col gap-6 flex-shrink-0 min-w-0">
                    @if ($activeSession)
                        <div class="bg-white dark:bg-slate-950 xl border border-slate-200 dark:border-slate-800 p-6 flex flex-col items-center justify-center text-center">
                            ...
                            <div class="flex items-center gap-2 text-xs">
                                <span class="bg-slate-100 dark:bg-slate-800 px-3 py-1 font-mono font-bold text-slate-700 dark:text-slate-300">
                                    {{ $activeSession->token }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="bg-slate-900 dark:bg-black xl p-6 text-white flex-1 flex flex-col justify-center relative overflow-hidden group">
