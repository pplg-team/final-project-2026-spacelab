    ...
    <section class="pt-28 pb-20 px-4 sm:px-6 lg:px-8 bg-slate-50  min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <nav class="flex items-center gap-2 text-sm text-slate-500  mb-8">
                ...
                <span class="text-slate-900  font-medium">Cari Guru</span>
            </nav>

            {{-- Header --}}
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold text-slate-900  mb-3">Cari Guru</h1>
            ...
            @if (strlen($query) >= 2)
                            ...
                            <div
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-14 h-14 bg-slate-200  flex items-center justify-center text-lg font-semibold text-slate-600 ">
                                    ...
                                    <div class="flex-1 min-w-0">
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                                                    ...
                                                    <div class="flex items-center gap-1.5">
                                                        ...
                                                        <span
                                                            class="text-sm text-slate-700 ">{{ $result['currentClassroom']?->full_name ?? '-' }}</span>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            <div
                                                class="mt-3 p-3 bg-slate-50  border border-slate-100 ">
                                                <p class="text-xs text-slate-400  italic">Tidak
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-lg font-semibold text-slate-900  mb-2">Guru tidak ditemukan</h3>
            ...
            @else
                {{-- Empty State --}}
                <div class="text-center py-16">
                    <x-heroicon-o-academic-cap class="w-16 h-16 text-slate-300  mx-auto mb-4" />
